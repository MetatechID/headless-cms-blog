...
export const MacbookScroll = ({
  ...
  return (
    <div
      ref={ref}
      className="flex  min-h-[100vh] flex-shrink-0 scale-[0.35] transform flex-col items-center justify-start py-0 [perspective:800px] sm:min-h-[200vh] sm:scale-50  md:scale-100 md:py-40"
    >
      {/* <motion.h2
        style={{
