      ...
      <SectionHeading className="flex justify-between gap-4">
        ...
        <div className="mr-4 sm:mr-28">
          <button
            onClick={(e) => {
              window.open(
                "https://www.instagram.com/jayaberanimaju/",
                "_blank",
              );
            }}
            className="felx-col flex justify-center gap-2 rounded-md border border-primaryBlueColor px-4 py-2 text-base font-normal text-primaryBlueColor"
          >
            <svg
              width="24"
              height="24"
